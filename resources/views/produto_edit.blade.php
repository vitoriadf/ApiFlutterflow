    ...
    <form action="{{ route('produtos.update', $produto->id) }}" method="POST">
        ...
        <div class="grid gap-4 mb-6 md:grid-cols-2">
            ...
            <div class="col-span-1">
                ...
                <input type="number" name="quantidade" id="quantidade" class="form-control bg-fuchsia-200 border border-fuchsia-900 text-fuchsia-900 placeholder-fuchsia-900 rounded-lg p-2.5 focus:ring-2 focus:ring-fuchsia-900 w-full max-w-md" value="{{ old('quantidade', $produto->quantidade) }}">
            </div>
        </div>
