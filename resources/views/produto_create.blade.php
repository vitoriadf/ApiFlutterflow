...
<div class="container mx-auto p-6 bg-fuchsia-200 max-w-4xl">
    ...
    <form action="{{ route('produtos.store') }}" method="POST">
        ...
        <div class="grid gap-4 mb-6 grid-cols-1 sm:grid-cols-2">
            <div class="col-span-1">
                <label for="nome" class="block mb-2 text-sm font-medium text-fuchsia-900">Nome do Produto</label>
                <input type="text" name="nome" id="nome" class="form-control bg-fuchsia-200 border border-fuchsia-900 text-fuchsia-900 rounded-lg p-2.5 focus:ring-2 focus:ring-fuchsia-900 placeholder-fuchsia-900 w-full" placeholder="Nome do produto">
            </div>

            <div class="col-span-1">
                <label for="preco" class="block mb-2 text-sm font-medium text-fuchsia-900">Preço</label>
                <input type="number" step="0.01" name="preco" id="preco" class="form-control bg-fuchsia-200 border border-fuchsia-900 text-fuchsia-900 placeholder-fuchsia-900 rounded-lg p-2.5 focus:ring-2 focus:ring-fuchsia-900 w-full" placeholder="Preço">
            </div>
        </div>
        ...
        <div class="grid gap-4 mb-6 grid-cols-1 sm:grid-cols-2">
            <div class="col-span-1">
                ...
                <select name="marca_id" id="marca" class="form-select bg-fuchsia-200 border border-fuchsia-900 text-fuchsia-900 rounded-lg p-2.5 focus:ring-2 focus:ring-fuchsia-900 w-full">
            ...
            <div class="col-span-1">
                ...
                <select name="cor_id" id="cor" class="form-select bg-fuchsia-200 border border-fuchsia-900 text-fuchsia-900 rounded-lg p-2.5 focus:ring-2 focus:ring-fuchsia-900 w-full">
        ...
        <div class="grid gap-4 mb-6 grid-cols-1 sm:grid-cols-2">
            <div class="col-span-1">
                ...
                <select name="categoria_id" id="categoria" class="form-select bg-fuchsia-200 border border-fuchsia-900 text-fuchsia-900 rounded-lg p-2.5 focus:ring-2 focus:ring-fuchsia-900 w-full">
            ...
            <div class="col-span-1">
                ...
                <select name="tecido_id" id="tecido" class="form-select bg-fuchsia-200 border border-fuchsia-900 text-fuchsia-900 rounded-lg p-2.5 focus:ring-2 focus:ring-fuchsia-900 w-full">
        ...
        <div class="col-span-2 flex justify-center">
            <div class="w-full max-w-md">
                ...
                <input type="number" name="quantidade" id="quantidade" class="form-control bg-fuchsia-200 border border-fuchsia-900 text-fuchsia-900 placeholder-fuchsia-900 rounded-lg p-2.5 focus:ring-2 focus:ring-fuchsia-900 w-full" placeholder="Quantidade">
            </div>
        </div>
