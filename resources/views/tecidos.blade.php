...
<div class="max-w-5xl mx-auto mt-12 mb-6 flex justify-between items-center">
    ...
    <div class="mt-2">
    <a href="{{ route('tecidos.create') }}" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 ">
            Adicionar
        </a>
    </div>
</div>
    ...
    <table class="w-full text-left text-sm">
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-fuchsia-200 text-fuchsia-900">
                <td class="py-2 text-center">{{ $tecido->id }}</td>
                <td class="py-2 text-center">{{ $tecido->nome }}</td>
                <td class="py-2 text-center">
                    <div class="inline-flex space-x-4">
                        <a href="{{ route('tecidos.edit', ['tecido' => $tecido->id]) }}"
                            class="font-medium text-blue-600 hover:underline">Editar</a>
                        <a href="{{ route('tecidos.destroy', $tecido->id) }}"
